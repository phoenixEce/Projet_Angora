    ...
    function insertOrUpdateNegotiation($connection, $id_article, $id_vendeur, $id_acheteur, $offre_acheteur)
    {
        try {
            ...
            if ($row = mysqli_fetch_assoc($result)) {
                ...
                sendNotification($connection, 1, "Offre mise à jour par le client à hauteur de " . $offre_acheteur . "$");
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['offer'])) {
        ...
        $sql = "SELECT id_vendeur FROM article WHERE id_article = ".$_GET["id"].";";
    ...
    <script>
        ...
        function submitOffer() {
            ...
            fetch('<?php echo $_SERVER['PHP_SELF']; ?>', {
                    ...
                    body: 'offer=' + encodeURIComponent(amount)
                })
                .then(response => {
                    if (!response.ok) {
